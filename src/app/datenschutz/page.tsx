...
export const metadata = {
  title: "Datenschutz — Amanah Vorsorge",
  description: "Datenschutzerklärung für Amanah Vorsorge — lokale und serverseitige Speicherung, KI, Export und Löschung.",
};
      ...
      <div className="prose prose-sm max-w-none space-y-8 text-muted">
        <section>
          ...
          <p className="leading-relaxed">
            Verantwortlich für die Datenverarbeitung im Rahmen von Amanah Vorsorge ist der Betreiber der Plattform.
            Kontakt:{" "}
        ...
        <section>
          ...
          <p className="leading-relaxed">
            Amanah Vorsorge speichert <strong className="text-foreground">keine Zugangspasswörter</strong> zu deinen
        ...
        <section>
          ...
          <p className="leading-relaxed">
            Amanah Vorsorge verwendet derzeit keine Tracking-Cookies und kein werbliches Profiling.
