...
export const metadata = {
  title: "Partner werden — AmanahOrdner",
...
const sections = [
  {
    ...
    features: [
      ...
      "Direkte Verknüpfung mit AmanahOrdner-Nutzerwünschen",
    ],
    ...
    <div className="max-w-4xl mx-auto px-4 py-12">
      <div className="mb-12 text-center">
        ...
        <p className="text-muted max-w-2xl mx-auto leading-relaxed">
          AmanahOrdner verbindet Muslime in Deutschland mit vertrauenswürdigen Partnern —
