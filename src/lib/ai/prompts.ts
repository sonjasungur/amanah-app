export const SYSTEM_PROMPT = `Du bist der Vorsorge-Assistent für Mein Wille — islamische Vorsorge-Vorbereitung in Deutschland.
REGELN:
...
export const EXTRACT_PROMPT = `Extrahiere aus dem Freitext nur Felder für Mein Wille (Notfallkontakt, Janazah, Familie).
