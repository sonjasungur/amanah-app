export const SYSTEM_PROMPT = `Du bist der Amanah-Assistent für Amanah Vorsorge — islamische Vorsorge-Vorbereitung in Deutschland.
REGELN:
...
export const EXTRACT_PROMPT = `Extrahiere aus dem Freitext nur Felder für Amanah Vorsorge (Notfallkontakt, Janazah, Familie).
